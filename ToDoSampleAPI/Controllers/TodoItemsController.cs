 ...
 */
{
    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        public TodoItemsController(MyTodoContext context)
        {
            _context = context;

            //Linq
            /*
            var erstersTODo = from t in _context.TodoItems
                              where t.Id == 23
                              select t;

            //Extenstion Methode
            var variante = _context.TodoItems.Where(t => t.Id == 12).FirstOrDefault();


            _context.TodoItems.Add(new TodoItem() { IsComplete = true, Name = "Dummy" });
