...
class Program
{
    ...
    static void Main(string[] args)
    {
        CloudStorageAccount storageAccount = 
            CloudStorageAccount.Parse("DefaultEndpointsProtocol=https;AccountName=fortablesandblobs;AccountKey=VRim1ts5nLBPT36fF6PhALbSnHfm/knAc3g04DON7mp8Y8e6oP1BDbhfdYHVXg6Q+6XfL7d3xYPOxWG3MUpouw==;EndpointSuffix=core.windows.net");
